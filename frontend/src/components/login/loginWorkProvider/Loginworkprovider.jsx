...
// import { LOGIN_URL, TYPE_POST } from "../../../fetchers/constants.js";
// import { pokeBarterForSkillsServer } from "../../../fetchers/fetchers.js";
...
//     username: "",
//     usertype: "workprovider",
//     email: "",
//     password: "",
//     subscription: "workprovider-basic",
//     personaldetails: {
//       name: "",
//       conatactno: "",
//       skills: [],
...
//         data: { email: userData.email, otp: otp, usertype: "workprovider" },
//       };
//       const otpVerResponse = await pokeBarterForSkillsServer(`${LOGIN_URL}`,options,TYPE_POST)
//         // "https://barter-5cky.onrender.com/login",
//       if (otpVerResponse.otpverified) {
//         if (otpVerResponse.existinguser) {
//           // localStorage.setItem(
//           //   "response-userdata",
//           //   JSON.stringify(otpVerResponse.data),
//           // );
//           navigate(
//             `/welcome/workprovider/wpd78x/${encodeURIComponent(otpVerResponse.data.userData.username)}`,
//           );
//         } else {
//           // localStorage.setItem(
//           //   "response-userdata",
...
//         );
//         navigate(
//           `/welcome/workprovider/wpd78x/${encodeURIComponent(passwordVerification.data.userData.username)}`,
//         );
//       } else {
