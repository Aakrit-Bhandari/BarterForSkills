...
import img from "../../assets/barter.png";
...
const Editprofile = () => {
    ...
    const fetchSkills = async () => {
      try {
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/skills/${userId}`,
        );
  ...
  const addSkill = async () => {
    if (!newSkill || !experience) {
      alert("Empty skill or exp");
      return;
    }
    try {
      const response = await axios.post(
        // "https://barter-5cky.onrender.com/profile/qualification/addskill",
        "http://localhost:3000/profile/qualification/addskill",
  ...
  const deleteUserSkill = async (skillId) => {
    try {
      await axios.delete(
        // `https://barter-5cky.onrender.com/profile/qualification/deleteSkill/${skillId}`,
        `http://localhost:3000/profile/qualification/deleteSkill/${skillId}`,
        {
          data: { userId: userId },
        },
      );
  ...
  const updateSkill = async () => {
    ...
    try {
      ...
      await axios.put(
        // "https://barter-5cky.onrender.com/profile/qualification/editskills",
        "http://localhost:3000/profile/qualification/editskills",
        {
          userId: userId,
    ...
    const fetchWorkExp = async () => {
      try {
        ...
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/workExp/${userId}`,
        );
  ...
  const addWorkExp = async () => {
    if (!newTitle || !company) {
      alert("Empty title or company");
      return;
    }
    try {
      const response = await axios.post(
        // "https://barter-5cky.onrender.com/profile/qualification/addWorkExp",
        "http://localhost:3000/profile/qualification/addWorkExp",
  ...
  const updateWorkExp = async () => {
    ...
    try {
      ...
      setCurrentEditIndex(null);
      await axios.put(
        // "https://barter-5cky.onrender.com/profile/qualification/editWorkExp",
        "http://localhost:3000/profile/qualification/editWorkExp",
        {
          userId: userId,
  ...
  const deleteWorkExp = async (workExpId) => {
    try {
      await axios.delete(
        // `https://barter-5cky.onrender.com/profile/qualification/deleteUserWorkExp/${workExpId}`,
        `http://localhost:3000/profile/qualification/deleteUserWorkExp/${workExpId}`,
        {
          data: { userId: userId },
        },
      );
    ...
    const fetchEducation = async () => {
      try {
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/education/${userId}`,
        );
  ...
  const addEducation = async () => {
    ...
    try {
      const response = await axios.post(
        ...
        "http://localhost:3000/profile/qualification/addEducation",
  ...
  const updateEducation = async () => {
    try {
      ...
      await axios.put(
        // "https://barter-5cky.onrender.com/profile/qualification/editEducation",
        "http://localhost:3000/profile/qualification/editEducation",
        {
          userId: userId,
          updatedEducation,
        },
  ...
  const deleteUserEducation = async (eduId) => {
    try {
      await axios.delete(
        //`https://barter-5cky.onrender.com/profile/qualification/deleteUserEducation/${eduId}`,
        `http://localhost:3000/profile/qualification/deleteUserEducation/${eduId}`,
        {
          data: { userId: userId },
        },
      );
    ...
    const fetchLicence = async () => {
      try {
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/licence/${userId}`,
        );
  ...
  const addLicence = async () => {
    ...
    try {
      const response = await axios.post(
        ...
        "http://localhost:3000/profile/qualification/addLicence",
  ...
  const updateLicence = async () => {
    try {
      ...
      await axios.put(
        // "https://barter-5cky.onrender.com/profile/qualification/editLanguage",
        "http://localhost:3000/profile/qualification/editLanguage",
        {
          userId: userId,
  ...
  const deleteUserLicence = async (licenceId) => {
    try {
      await axios.delete(
        // `https://barter-5cky.onrender.com/profile/qualification/deleteUserLicence/${licenceId}`,
        `http://localhost:3000/profile/qualification/deleteUserLicence/${licenceId}`,
        {
          data: { userId: userId },
        },
      );
    ...
    const fetchCertificate = async () => {
      try {
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/certificate/${userId}`,
        );
  ...
  const addCertificate = async () => {
    if (!newCertificate) {
      alert(" ERRORR Addsomthing");
      return;
    }
    try {
      const response = await axios.post(
        // "https://barter-5cky.onrender.com/profile/qualification/addCertificate",
        "http://localhost:3000/profile/qualification/addCertificate",
  ...
  const updateCertificate = async () => {
    try {
      ...
      await axios.put(
        // "https://barter-5cky.onrender.com/profile/qualification/editUserCertificate",
        "http://localhost:3000/profile/qualification/editUserCertificate",
        {
          userId: userId,
  ...
  const deleteCerificate = async (certifId) => {
    ...
    try {
      await axios.delete(
        // `https://barter-5cky.onrender.com/profile/qualification/deleteUserCertificate/${certifId}`,
        `http://localhost:3000/profile/qualification/deleteUserCertificate/${certifId}`,
        {
          data: { userId: userId },
        },
      );
    ...
    const fetchLanguage = async () => {
      try {
        const response = await axios.get(
          ...
          `http://localhost:3000/profile/qualification/language/${userId}`,
        );
  ...
  const addLanguage = async () => {
    if (!newLanguage || !fluency) {
      alert("ERROR addsomething");
      return;
    }
    try {
      const response = await axios.post(
        // "https://barter-5cky.onrender.com/profile/qualification/addLanguage",
        "http://localhost:3000/profile/qualification/addLanguage",
  ...
  const deleteLanugage = async (langId) => {
    try {
      await axios.delete(
        // `https://barter-5cky.onrender.com/profile/qualification/deleteUserLanguage/${langId}`,
        `http://localhost:3000/profile/qualification/deleteUserLanguage/${langId}`,
        {
          data: { userId: userId },
        },
      );
      ...
      <section className="Profile_Qualification_Main Profile_Design">
        {isModalSkills && (
          <div className="Profile_modal-overlay">
            <div
              className="Profile_modal-content"
              ...
              <div className="Profile_modal_display">
                {skills.map((mp, id) => (
                  <div key={mp.id} className="Profile_modal_display_flowlist">
                    <p style={{ marginBottom: "0px", color: "purple" }}>
                      {mp.skill} - <span>{mp.experience} years</span>
                    </p>
                    <button onClick={() => editSkill(id)}>Edit</button>
                    <button onClick={() => deleteUserSkill(mp.id)}>
                      Delete
                    </button>
                  </div>
                ))}
          ...
          <div className="Profile_modal-overlay">
            ...
            >
              ...
              <div className="Profile_modal_display">
                {certificate.map((mp, id) => (
                  <div key={mp.id} className="Profile_modal_display_flowlist">
                    ...
                    <button onClick={() => deleteCerificate(mp._id)}>
                      Delete
                    </button>
                  </div>
                ))}
              ...
              <div className="Profile_modal_buttons">
                ...
                <button onClick={() => setisModalCertificate(false)}>
                  Close
                </button>
              </div>
            </div>
            ...
            >
              ...
              <div className="Profile_modal_display">
                {licence.map((mp, id) => (
                  <div key={mp.id} className="Profile_modal_display_flowlist">
                    <p style={{ marginBottom: "0px", color: "purple" }}>
                      {mp.licencename}-{mp.year}
                    </p>
                    <button onClick={() => editLicence(id)}>Edit</button>
                    <button onClick={() => deleteUserLicence(mp.id)}>
                      Delete
                    </button>
                  </div>
                ))}
            ...
            >
              ...
              <div className="Profile_modal_display">
                {education.map((mp, id) => (
                  <div key={mp.id} className="Profile_modal_display_flowlist">
                    <p style={{ marginBottom: "0px", color: "purple" }}>
                      {mp.levelofedu}-{mp.fieldofstudy}
                    </p>
                    <button onClick={() => editEducation(id)}>Edit</button>
                    <button onClick={() => deleteUserEducation(mp.id)}>
                      Delete
                    </button>
                  </div>
                ))}
              ...
              <div className="Profile_modal_buttons">
                ...
                <button onClick={() => setisModalEducation(false)}>
                  Close
                </button>
              </div>
            </div>
            ...
            <div className="Profile_modal_display">
              {language.map((lang) => (
                <div key={lang.id} className="Profile_modal_display_flowlist">
                  <p style={{ marginBottom: "0px", color: "purple" }}>
                    {lang.langName}-{lang.proficiency}
                  </p>
                  <button onClick={() => deleteLanugage(lang.id)}>
                    delete
                  </button>
                </div>
              ))}
        ...
        <div className="Profile_Qualificatoin_ContComp Profile_Desig_Comp">
          <div className="Profile_Design_Heading">
            ...
            <p>
              We use these details to show you jobs that match your unique
