...
const Jobdisplay = ({ projectdata, filtercount, worker, userid, status }) => {
  ...
  const handleskillsreqChange = (e) => {
    const skillsreqArray = e.target.value
      .split(",")
      ...
      {visited && (
        <div className="edit-project-modal">
          <div className="edit-project-form">
            ...
            <button className="edit-project-close-button" onClick={handleClose}>
              Close
            </button>
            <form onSubmit={performupdate}>
              ...
              <br />
              <button type="submit" className="edit-project-submit-button">
                Update
              </button>
            </form>
          </div>
